...
"""
Single origin constrained gravity model
    ...
    def run(self):
        ...
        while not converged:
            ...
            for i in range(0,self.m):
                ...
                #print("denom=",denom)
                #faster...?
                denom2=np.sum(self.DjObs*expBetaCij[i,:])
                #print(denom2)
                ...
                #faster
                Tij2=self.OiObs[i]*(self.DjObs*expBetaCij[i]/denom2)
            ...
            delta = DjPredSum-DjObsSum

            #delta check on beta stopping condition for convergence
            #gradient descent search on beta
            converged = True
            if delta / DjObsSum > 0.001:
                beta = beta * DjPredSum / DjObsSum
                converged = False
            print("beta=",beta,"delta=",delta,"DjPredSum",DjPredSum,"DjObsSum",DjObsSum)
