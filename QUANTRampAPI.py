...
dfHospitalPopulation = pd.read_csv('model-runs/hospitalPopulation.csv')
dfHospitalZones = pd.read_csv('model-runs/hospitalZones.csv')
hospital_probHij = loadMatrix('model-runs/hospitalProbHij.bin')
